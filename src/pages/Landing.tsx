...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative px-4 pt-32 pb-24 sm:px-6 lg:px-8 sm:pt-40 bg-[linear-gradient(135deg,hsl(var(--background)),hsl(var(--card)),hsl(var(--surface-elevated)))]">
